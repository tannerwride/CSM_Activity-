...
You would navigate to a customer's CircleCI Insights page, sort by credits. Next, click on a specific workflow, then use the three dots to get to the configuration file. 
